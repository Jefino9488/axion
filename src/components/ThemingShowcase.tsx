        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="glass-panel rounded-3xl p-6 group">
            <div className="relative aspect-[9/16] rounded-2xl overflow-hidden">
              <Image src="/screenshots/photo_17_2026-08-02_22-34-34.jpg" alt="Green themed notification shade" fill className="object-cover object-top transition-transform duration-700 group-hover:scale-105" />
            </div>
            <div className="mt-4">
          ...
          <div className="glass-panel rounded-3xl p-6 group">
            <div className="relative aspect-[9/16] rounded-2xl overflow-hidden">
              <Image src="/screenshots/photo_23_2026-08-02_22-34-34.jpg" alt="Purple themed notification shade with media player" fill className="object-cover object-top transition-transform duration-700 group-hover:scale-105" />
            </div>
            <div className="mt-4">
